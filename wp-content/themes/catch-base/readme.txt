...
= 3.4.6 (Released: December 01, 2023) =
* Updated: WordPress 6.4 ready

= 3.4.5 (Released: August 29, 2022) =
* Updated: WordPress 6.0 ready

= 3.4.4 (Released: March 15, 2022) =
* Added: Fitvids Option (Fixed Video Spacing issue)
* Bug Fixed: Upgrade Now button URL in Customizer

= 3.4.3 (Released: February 05, 2022) =
...
* Updated: Danish translation da_DK.po and da_DK.mo
* Updated: German translation de_DE.po and de_DE.mo

= 2.8.2 =
* Bug Fixed: White space issues at the end of files
...
= 2.8 =
* Fixed: Featured Page Content anchor attribute issue (title missing)
...
* Bug Fixed: German language translation issue in de_DE.po and de_DE.mo file

= 2.7 =
* Added: Disable scrollup option.
* Added: Social Icons for Phone, Handset, Cart, Cloud, Link( Custom Link )
* Bug Fixed: Featured Slider not looping
* Enhanced: Used antispambot() function on emails output on social icons
* Updated: Disable Logo checkbox to hide Logo, Logo alt text and Logo url
* Updated: Disable Featured Header Image to hide Header image size, Header image alt text, Header image url, Header image target
* Updated: Disable Promotion headline to hide Promotion headline text, Promotion subheadline text, Promotion headline button text, Promotion headline button url, Promotion headline target
* Updated: changed transport -> refresh to transport -> postMessage in Customizer API where feasible to make it more user friendly
...
* Updated: Text Domain in style.css updated to catch-base
* Updated: responsive menu script
* Updated: responsive css to fix iphone6 issue
